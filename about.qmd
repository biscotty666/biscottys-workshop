...
The best way to get an idea of my programming and data science skills are to look at some of the projects on the site. You can also find more [here](cv/_tech.qmd)
...
::: {.hide}
|# echo: false
All of the posts of my experiences can be found [here](cv/cv.qmd).
:::