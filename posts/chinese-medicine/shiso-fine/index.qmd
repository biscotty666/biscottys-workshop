...
description: The famous leaves served with sushi have myriad functions in Traditional Chinese Medicine
...
![Perilla plant[^5]](pretty-shiso.jpg){.lightbox fig-alt="Picture of Perilla plant" style="border-radius: 5%;"}
:::

[^5]: Original photo from <https://pxhere.com/en/photo/853091>
...
::: {style="float: left; width: 40%; margin-right: 10px;"}
![Purple seeds[^6]](su-zi.jpg){.lightbox fig-alt="Picture of perilla seeds" style="border-radius: 5%;"}
:::

[^6]: Image from [Sushi University](https://sushiuniversity.jp/sushiblog/what-is-the-difference-between-shiso-and-ooba/)
